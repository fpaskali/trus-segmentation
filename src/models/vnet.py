...
def model1(input_size = (128,128,128,1), weights = None, show_summary=False):
    inputs = Input(input_size)
    conv1_1 = Conv3D(filters=16, kernel_size=(3,3,3), activation=None, padding = 'same', strides =(1,1,1))(inputs)
    conv1_1 = PReLU()(BatchNormalization()(conv1_1))
    conv1_2 = Conv3D(filters=16, kernel_size=(3,3,3), activation=None, padding = 'same', strides =(1,1,1))(conv1_1)
    ...
    conv2_1 = PReLU()(BatchNormalization()(Conv3D(filters=32, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(downconv1)))
    conv2_2 = PReLU()(BatchNormalization()(Conv3D(filters=32, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(conv2_1)))
    ...
    conv3_1 = PReLU()(BatchNormalization()(Conv3D(filters=64, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(downconv2)))
    conv3_2 = PReLU()(BatchNormalization()(Conv3D(filters=64, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(conv3_1)))
    conv3_3 = PReLU()(BatchNormalization()(Conv3D(filters=64, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(conv3_2)))
    ...
    conv4_1 = PReLU()(BatchNormalization()(Conv3D(filters=128, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(downconv3)))
    conv4_2 = PReLU()(BatchNormalization()(Conv3D(filters=128, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(conv4_1)))
    conv4_3 = PReLU()(BatchNormalization()(Conv3D(filters=128, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(conv4_2)))
    ...
    conv5_1 = PReLU()(BatchNormalization()(Conv3D(filters=256, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(downconv4)))
    conv5_2 = PReLU()(BatchNormalization()(Conv3D(filters=256, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(conv5_1)))
    conv5_3 = PReLU()(BatchNormalization()(Conv3D(filters=256, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(conv5_2)))
    ...
    conv4_4 = PReLU()(BatchNormalization()(Conv3D(filters=128, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(concat4)))
    conv4_5 = PReLU()(BatchNormalization()(Conv3D(filters=128, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(conv4_4)))
    conv4_6 = PReLU()(BatchNormalization()(Conv3D(filters=128, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(conv4_5)))
    sum_forth_layer_up = add([conv4_6, upconv5])
    
    upconv4 = Conv3DTranspose(filters=64, kernel_size=(2,2,2), activation=None, padding='valid', strides=(2,2,2))(sum_forth_layer_up)
    upconv4 = PReLU()(BatchNormalization()(upconv4))
    upconv4_1 = Conv3DTranspose(filters=32, kernel_size=(2,2,2), padding='valid', strides=(2,2,2))(upconv4)
    upconv4_2 = Conv3DTranspose(filters=16, kernel_size=(2,2,2), padding='valid', strides=(2,2,2))(upconv4_1)
    
    concat3 = Concatenate(axis=-1)([sum_third_layer, upconv4])
    
    conv3_4 = PReLU()(BatchNormalization()(Conv3D(filters=64, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(concat3)))
    conv3_5 = PReLU()(BatchNormalization()(Conv3D(filters=64, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(conv3_4)))
    conv3_6 = PReLU()(BatchNormalization()(Conv3D(filters=64, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(conv3_5)))
    ...
    conv2_3 = PReLU()(BatchNormalization()(Conv3D(filters=32, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(concat2)))
    conv2_4 = PReLU()(BatchNormalization()(Conv3D(filters=32, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(conv2_3)))
    ...
    conv1_3 = PReLU()(BatchNormalization()(Conv3D(filters=16, kernel_size=(3,3,3), activation=None, padding='same', strides=(1,1,1))(concat1)))
    sum_first_layer_up = add([conv1_3, upconv2])
            
    concat_prefinal = Concatenate(axis=-1)([upconv4_2, upconv3_1, upconv2, sum_first_layer_up])
...
def model2(input_size = (128,128,128,1), weights = None,  show_summary=False):
    inputs = Input(input_size)
    conv1_1 = Conv3D(filters=16, kernel_size=(3,3,3), activation=None, padding = 'same', strides =(1,1,1))(inputs)
    conv1_1 = PReLU()(BatchNormalization()(conv1_1))
    conv1_2 = Conv3D(filters=16, kernel_size=(3,3,3), activation=None, padding = 'same', strides =(1,1,1))(conv1_1)
